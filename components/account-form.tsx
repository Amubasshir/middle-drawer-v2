...
//           {/* please add here a select button called "additional account" where users can select
//           Account Number: (data type text)
// Secondary person: (data type text)
// Phone number: (phone)
// Additional Balance: (data type numeric)
// Additional password: (data type password/text)
// other notes: (data type textarea)

// above options.

// if they select that field will be add here. and that field should have delete button side. so that user can delete also. these fields only will be dynamic based on user selection. this can be multi select.
...
//     isActive: initialData?.isActive ?? true,
//     notes: initialData?.notes || "",
//     additionalAccounts: initialData?.additionalAccounts || [],
//   })

//   const [additionalAccounts, setAdditionalAccounts] = useState<AdditionalAccount[]>(
//     initialData?.additionalAccounts || []
//   )
...
//       otherNotes: ""
//     }
//     const updatedAccounts = [...additionalAccounts, newAccount]
//     setAdditionalAccounts(updatedAccounts)
//     setFormData(prev => ({
//       ...prev,
...
//   const removeAdditionalAccount = (id: string) => {
//     const updatedAccounts = additionalAccounts.filter(account => account.id !== id)
//     setAdditionalAccounts(updatedAccounts)
//     setFormData(prev => ({
//       ...prev,
//       additionalAccounts: updatedAccounts
...
//   const handleAdditionalAccountChange = (id: string, field: keyof AdditionalAccount, value: string) => {
//     const updatedAccounts = additionalAccounts.map(account => 
...
//               <Label className="text-lg font-medium">Additional Accounts</Label>
//               <Button 
//                 type="button" 
//                 variant="outline" 
...
//                   <h4 className="font-medium">Additional Account</h4>
//                   <Button
//                     type="button"
//                     variant="ghost"
//                     size="sm"
//                     onClick={() => removeAdditionalAccount(account.id)}
...
//                       onChange={(e) => handleAdditionalAccountChange(account.id, 'accountNumber', e.target.value)}
//                       placeholder="Account number"
//                     />
//                   </div>
                  
//                   <div className="space-y-2">
//                     <Label htmlFor={`secondaryPerson-${account.id}`}>Secondary Person</Label>
//                     <Input
//                       id={`secondaryPerson-${account.id}`}
//                       value={account.secondaryPerson}
//                       onChange={(e) => handleAdditionalAccountChange(account.id, 'secondaryPerson', e.target.value)}
//                       placeholder="Secondary person name"
//                     />
//                   </div>
                  
//                   <div className="space-y-2">
//                     <Label htmlFor={`phoneNumber-${account.id}`}>Phone Number</Label>
//                     <Input
//                       id={`phoneNumber-${account.id}`}
//                       value={account.phoneNumber}
//                       onChange={(e) => handleAdditionalAccountChange(account.id, 'phoneNumber', e.target.value)}
//                       placeholder="Phone number"
//                     />
//                   </div>
                  
//                   <div className="space-y-2">
//                     <Label htmlFor={`additionalBalance-${account.id}`}>Additional Balance</Label>
//                     <Input
//                       id={`additionalBalance-${account.id}`}
//                       type="number"
//                       step="0.01"
//                       value={account.additionalBalance}
//                       onChange={(e) => handleAdditionalAccountChange(account.id, 'additionalBalance', e.target.value)}
//                       placeholder="0.00"
//                     />
//                   </div>
                  
//                   <div className="space-y-2">
//                     <Label htmlFor={`additionalPassword-${account.id}`}>Additional Password</Label>
//                     <Input
//                       id={`additionalPassword-${account.id}`}
//                       type="password"
//                       value={account.additionalPassword}
//                       onChange={(e) => handleAdditionalAccountChange(account.id, 'additionalPassword', e.target.value)}
...
//                   <Label htmlFor={`otherNotes-${account.id}`}>Other Notes</Label>
//                   <Textarea
//                     id={`otherNotes-${account.id}`}
//                     value={account.otherNotes}
//                     onChange={(e) => handleAdditionalAccountChange(account.id, 'otherNotes', e.target.value)}
...
//   { value: "secondaryPerson", label: "Secondary Person", type: "text" },
//   { value: "phoneNumber", label: "Phone Number", type: "tel" },
//   { value: "additionalBalance", label: "Additional Balance", type: "number" },
//   { value: "additionalPassword", label: "Additional Password", type: "password" },
//   { value: "otherNotes", label: "Other Notes", type: "textarea" },
// ]
