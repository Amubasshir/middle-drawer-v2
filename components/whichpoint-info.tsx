  ...
  const screens = [
      ...
      content: (
        <div className="space-y-4">
          <p className="text-base">
            <strong>Middle Drawer</strong> is designed for individuals who
            manage a complex digital footprint and need a reliable system to
            remember what matters the most.
          </p>
          <p className="text-base">
            If you've ever forgotten a password, missed a payment, or lost track
            of an important account, Middle Drawer is for you.
          </p>
          <p className="text-base">
            In today's digital world, keeping track of accounts, credentials,
            payment schedules, and responsibilities requires a new platform and
            framework.
          </p>
        </div>
      ),
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3 p-3 bg-muted/30 rounded text-sm">
                ...
                <div>
                  <span className="font-medium">Email Passphrase</span> - Least
                  secure
                </div>
              </div>
              <div className="flex items-start space-x-3 p-3 bg-muted/30 rounded text-sm">
                ...
                <div>
                  <span className="font-medium">SMS Verification</span> - Most
                  secure
                </div>
              </div>
            </div>
          ...
          <div>
            <p className="font-semibold text-base mb-2">
              Optional Cognitive Tracking:
            </p>
            <p className="text-sm text-muted-foreground">
              Non-invasive puzzles to track vision, reaction timing, and memory
              changes. Completely optional and not a clinical tool.
            </p>
          </div>
        </div>
      ),
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p className="font-semibold text-base mb-3">
            Middle Drawer acts as an independent safety net to ensure your
            accounts and digital footprint remain secure:
          </p>
          <div className="space-y-3">
            <div className="flex items-start space-x-3 p-3 bg-muted/30 rounded">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  You control what information to share. No sensitive data
                  required.
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-3 p-3 bg-muted/30 rounded">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Choose who to contact, how often, and how aggressively.
                </p>
              </div>
            </div>
            <div className="flex items-start space-x-3 p-3 bg-muted/30 rounded">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  You decide when and how your contacts are notified.
                </p>
              </div>
            </div>
          </div>
